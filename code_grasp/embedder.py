...
class Embedder:
        ...
        if not force_lightweight:
            try:
                ...
                self.tokenizer = AutoTokenizer.from_pretrained(
                    "Qodo/Qodo-Embed-1-1.5B", trust_remote_code=True, low_cpu_mem_usage=True
                )
    ...
    def embed_files_in_dir(self, directory, batch_size=4):
        ...
        print(
            f"Successfully processed {processed_files - skipped_files}/{total_files} files. Skipped {skipped_files} files."
        )
